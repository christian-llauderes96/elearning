	...
	<div class="card-body">
		<table class="table table-bordered table-compact table-stripped">
			...
			<tbody>
				...
				$qry = $conn->query("SELECT l.*,s.subject_code FROM lessons l inner join subjects s on s.id = l.subject_id where l.academic_year_id = '{$academic_year_id}' and l.faculty_id = '{$faculty_id}' ORDER BY s.subject_code ASC");
